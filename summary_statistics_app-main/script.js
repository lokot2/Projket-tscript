...
var UI = (function () {
    ...
    UI.prototype.generateUI = function (inputCount, values) {
        ...
        sections.push(this.generateStat('Minimum', stats.min, valuesToCount));
        sections.push(this.generateStat('Maximum', stats.max, valuesToCount));
    ...
    UI.prototype.generateInvalidUI = function () {
        ...
        invalidMsg.innerText = "You need to have at least value of 1.";
